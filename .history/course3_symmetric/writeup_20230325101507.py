...
def sub_bytes(s, sbox=s_box):
    ...
    for i in range(len(s)):
        ...
        # key += [[
        #     s_box[ int("0x0"+hexstate[i][a][0],16) ][ int("0x0"+hexstate[i][a][1],16) ] 
        #     for a in range(len(hexstate[i]))
        #     ]]
        print(sbox(int("0x0"+hexstate[i][0][0],16)))
        # print(s_box[ int("0x0"+hexstate[i][0][0],16) ][ int("0x0"+hexstate[i][0][1],16) ])
    return key
