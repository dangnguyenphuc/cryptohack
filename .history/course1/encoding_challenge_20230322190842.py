...
#     to_send = {
#         "decoded": (decoded(received["encoded"],received["type"])).decode('utf-8')
#     }
#     json_send(to_send)
#     json_recv()
# print( received["encoded"])

0x72656769737465725f6f776e65645f657965
print(long_to_bytes(0x72656769737465725f6f776e65645f657965,16)))